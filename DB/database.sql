...
fe7ea1dc-593a-11f1-b4ac-e073e7dfd89f:1-19';
...
INSERT INTO `caja` VALUES (1,1,'2026-05-26 15:25:57',NULL,1000.00,0.00,0.00,1000.00,'ABIERTO');
...
--
-- Table structure for table `egreso_caja`
--

DROP TABLE IF EXISTS `egreso_caja`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `egreso_caja` (
  ...
  KEY `id_caja` (`id_caja`),
  CONSTRAINT `egreso_caja_ibfk_1` FOREIGN KEY (`id_caja`) REFERENCES `caja` (`id_caja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `egreso_caja`
--

LOCK TABLES `egreso_caja` WRITE;
/*!40000 ALTER TABLE `egreso_caja` DISABLE KEYS */;
/*!40000 ALTER TABLE `egreso_caja` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ingreso_caja`
--

DROP TABLE IF EXISTS `ingreso_caja`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ingreso_caja` (
  ...
  KEY `id_caja` (`id_caja`),
  CONSTRAINT `ingreso_caja_ibfk_1` FOREIGN KEY (`id_caja`) REFERENCES `caja` (`id_caja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ingreso_caja`
--

LOCK TABLES `ingreso_caja` WRITE;
/*!40000 ALTER TABLE `ingreso_caja` DISABLE KEYS */;
/*!40000 ALTER TABLE `ingreso_caja` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `inventario` VALUES (1,1,40,10,'2026-05-26 15:25:53'),(2,2,30,10,'2026-05-26 15:25:53'),(3,3,25,10,'2026-05-26 15:25:53'),(4,4,35,10,'2026-05-26 15:25:53'),(5,5,25,8,'2026-05-26 15:25:53'),(6,6,40,10,'2026-05-26 15:25:53'),(7,7,20,5,'2026-05-26 15:25:53'),(8,8,50,10,'2026-05-26 15:25:53'),(9,9,15,5,'2026-05-26 15:25:53'),(10,10,18,5,'2026-05-26 15:25:53'),(11,11,22,5,'2026-05-26 15:25:53'),(12,12,18,5,'2026-05-26 15:25:53'),(13,13,15,5,'2026-05-26 15:25:53');
...
CREATE TABLE `reporte` (
  ...
  `generado_por` varchar(100) DEFAULT NULL,
...
INSERT INTO `usuario` VALUES (1,1,'admin','admin','123456','carlos@gmail.com',1,'2026-05-26 15:25:14'),(2,2,'María Flores','ventas','123456','maria@gmail.com',1,'2026-05-26 15:25:14');
...
-- Dump completed on 2026-06-18 15:59:40
