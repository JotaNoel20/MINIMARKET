...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $consulta_sql = "INSERT INTO producto (id_categoria, id_proveedor, nombre, descripcion, precio_venta, precio_compra, stock_actual, stock_minimo, estado, fecha_registro) 
                         VALUES (:id_categoria, 1, :nombre, :descripcion, :precio_venta, :precio_compra, :stock_actual, :stock_minimo, :estado, NOW())";
        ...
        <div class="contenedor-formulario">
            ...
            <form action="crear.php" method="POST">
                <div class="grupo-formulario">
                    ...
                    <input type="text" id="nombre" name="nombre" class="campo-entrada" placeholder="Ej. Galletas Soda" required>
                </div>
                ...
                <div class="grupo-formulario">
                    ...
                    <textarea id="descripcion" name="descripcion" class="campo-entrada" rows="3" placeholder="Detalles del producto..."></textarea>
                </div>

                <div class="fila-formulario">
                    <div class="grupo-formulario">
                        <label for="precio_compra">Precio de Compra (Bs.)</label>
                        <input type="number" id="precio_compra" name="precio_compra" class="campo-entrada" step="0.01" min="0" placeholder="0.00" required>
                    </div>
                    <div class="grupo-formulario">
                        <label for="precio_venta">Precio de Venta (Bs.)</label>
                        <input type="number" id="precio_venta" name="precio_venta" class="campo-entrada" step="0.01" min="0" placeholder="0.00" required>
                    </div>
                </div>
                ...
                <div class="fila-formulario">
                    <div class="grupo-formulario">
                        ...
                        <input type="number" id="stock_actual" name="stock_actual" class="campo-entrada" min="0" placeholder="0" required>
                    </div>
                    <div class="grupo-formulario">
                        <label for="stock_minimo">Stock Mínimo</label>
                        <input type="number" id="stock_minimo" name="stock_minimo" class="campo-entrada" min="0" placeholder="5" required>
                    </div>
                </div>
